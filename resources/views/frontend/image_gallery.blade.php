    ...
    <div class="banner-content">
        <div class="container">
            <div class="row gy-4 align-items-center">
                <div class="col-lg-6">
                    <span class="banner-title">Image Gallery</span>
                ...
                <div class="col-lg-6">
                    <div class="img-box">
                        <img src="<?php echo url(''); ?>/public/frontend/assets/images/page-banner-img1.webp" alt="Institute of Certified Public Accountant">
                    </div>
                </div>
            </div>
        </div>
...
<section class="image-gallery">
    <div class="container">
        <h5 class="gallery-subtitle">Image Gallery</h5>
        <h1 class="gallery-title">ARA Education’s Students Image Gallery</h1>
        <div class="row mt-4 g-3">
            @php
                $image_gallery = App\Models\ImageGallery::where('status', '1')
            ...
            @if($image_gallery)
                @foreach($image_gallery as $key=>$value)
                    <div class="col-md-4">
                        <div class="img-box">
                            <a href="<?php echo url(''); ?>/public/gallery_images/{{ $value->image }}" data-fancyBox="gallery"><img
                                    src="<?php echo url(''); ?>/public/gallery_images/{{ $value->image }}" alt=""></a>
                        </div>
                    </div>
                @endforeach
            @endif
