    ...
    <div class="banner-content">
        <div class="container">
            ...
            <div class="row gy-4 align-items-center">
                <div class="col-lg-6">
                <span class="banner-title">Blog</span>
...
<section class="blog-section-inner">
    <div class="container">
        ...
        <h2 class="blog-title">Blogs & Resource</h2>
                    ...
                    @foreach($blog as $key=>$value)
                        <div class="col-lg-4 col-md-6">
                            <div class="card blog-card">
                                <div class="img-box">
                                    <img src="<?php echo url(''); ?>/public/blog_images/{{ $value->image }}" alt="">
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title"><a href="{{ route('frontend.blog_details',$value->slug) }}">{{ $value->title }}</a></h5>
                                    <p class="card-text">{{ $value->short_description }}</p>
                                    <p class="mt-2 mb-0"><a href="{{ route('frontend.blog_details',$value->slug) }}"
                                            class="text-link">Read More</a>
                                    </p>
                                </div>
                            </div>
                        </div>
