...
@section('title', $blog_details->meta_title ?? 'CS ACS CA CMA  Institute Coimbatore ACCA USCMA CLAT Coaching center Tamilnadu - ARA Education')
@section('description', $blog_details->meta_description ?? 'Coimbatore’s best Coaching Institute for CA CS ACS CSEET CMA ICWA academy  is ARA Education. Tamilnadu’s No1 Coaching Center for  ACCA USCMA CLAT training India')
@section('keyword', $blog_details->meta_keyword ?? 'ca institute in Coimbatore ara education,best institute for ca
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-11 col-md-11">
                <h5 class="blog-subtitle">Blogs</h5>
                ...
                <div class="row gx-5 mt-4">
                    <div class="col-lg-6">
                        <div class="blog-img">
                            <img src="<?php echo url(''); ?>/public/blog_images/{{ $blog_details->image }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <p class="blog-text">{!! $blog_details->description !!}</p> 
                    </div>
                </div> 
            </div>
        </div>
