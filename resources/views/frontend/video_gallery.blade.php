    ...
    <div class="banner-content">
        <div class="container">
            <div class="row gy-4 align-items-center">
                <div class="col-lg-6">
                <span class="banner-title">Video Gallery</span>
            <nav aria-label="breadcrumb">
                ...
                <div class="col-lg-6">
                    <div class="img-box">
                        <img src="<?php echo url(''); ?>/public/frontend/assets/images/page-banner-img1.webp" alt="ARA Law Academy is the best coaching for AIBE Christ Law exam">
                    </div>
                </div>
            </div>
        </div>
...
<section class="image-gallery">
    <div class="container">
        <h5 class="gallery-subtitle">Video Gallery</h5>
        <h1 class="gallery-title">ARA Education’s Students Video Gallery</h1>
        <div class="row gy-4 mt-3">
            
            @php $video_gallery = App\Models\VideoGallery::where('status','1')->latest()->get(); @endphp
            @if($video_gallery)
                @foreach($video_gallery as $key=>$value)
                    <div class="col-md-6">
                        <div>
                            <div class="video-box"><iframe src="https://www.youtube.com/embed/{{ $value->youtube_link }}"
                                    title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    allowfullscreen="" id="fitvid0"></iframe></div>
                            <div class="title-box">{{ $value->title }}</div>
                        </div>
                    </div>
                @endforeach
            @endif
