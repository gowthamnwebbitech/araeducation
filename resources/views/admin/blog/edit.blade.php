        ...
        <div class="profile-tab">
            <div class="custom-tab-1">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a href="#profile-settings" data-bs-toggle="tab" class="nav-link active show">Edit Blog</a>
                    </li>
                </ul>
                                ...
                                @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div id="imagePreview">
                                                @if($blog->image)
                                                <img src="{{ url('public/blog_images/'.$blog->image) }}" class="img-thumbnail" width="80" /> @endif
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-6">
