            ...
            <div class="card-body">
                <div class="table-responsive" style="overflow-x: inherit;">
                    <table id="example4" class="display table table-bordered verticle-middle table-striped table-responsive-sm" style="min-width: 845px;">
                        ...
                        <tbody>
                            @foreach($videoGallery as $key => $item)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td>{{ $item->title }}</td>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="btn btn-info shadow btn-xs sharp me-2" href="javascript:void(0);" onclick="image_modal('{{ route('videoGallery.edit', encrypt($item->id) )}}')" title="Edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="javascript:void(0);" class="btn btn-danger shadow btn-xs sharp confirm-delete" data-href="{{route('videoGallery.destroy', $item->id)}}" title="Delete">
    ...
    <div class="col-lg-4">
        <div class="outer-box">
            <form method="POST" action="{{ route('videoGallery.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row gy-1">
                        <div class=" col-md-12">
                           <h4 class="mb-3">Video Gallery</h4><br>
                           <label for="status" class="form-label">Title</label>
                            ...
                            <input type="text" name="youtube_link" class="form-control" id="youtube_link" placeholder="" required />
                            <br>
